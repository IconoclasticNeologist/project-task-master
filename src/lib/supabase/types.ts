...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      project_knowledge: {
        Row: {
          ...
          status: Database["public"]["Enums"]["project_knowledge_status"]
          title: string
          updated_at: string
        }
        Insert: {
    ...
    Functions: {
      app_get_coach_note: { Args: never; Returns: string }
      app_index_embedding: {
        Args: {
          p_chunk_text: string
          p_embedding: string
          p_language: string
          p_source_id: string
          p_source_type: Database["public"]["Enums"]["embedding_source"]
        }
        Returns: undefined
      }
      app_list_documents: {
      ...
      app_recover_space: { Args: { p_hash: string }; Returns: boolean }
      app_recovery_status: { Args: never; Returns: string }
      app_save_document: {
        Args: {
          p_file_name: string
          p_mime_type: string
      ...
      app_save_timeline_event: {
        Args: {
          p_description: string
          p_event_date: string
          p_id: string
          p_relative_anchor: string
          p_visibility: Database["public"]["Enums"]["content_visibility"]
        }
        Returns: {
          created_at: string
      ...
      app_set_coach_note: { Args: { p_note: string }; Returns: undefined }
      app_set_recovery_words: { Args: { p_hash: string }; Returns: string }
      bump_usage: {
        Args: {
          _global_cap: number
          _per_user_cap: number
          _scope: string
          _subject: string
        }
        Returns: undefined
      ...
      coach_note_for_auth_user: { Args: { p_auth: string }; Returns: string }
      content_decrypt: { Args: { p: string }; Returns: string }
      content_encrypt: { Args: { p: string }; Returns: string }
      ...
      create_self_serve_survivor: { Args: never; Returns: string }
      ...
      delete_my_space: { Args: never; Returns: undefined }
      get_document_key: { Args: { p_survivor_id?: string }; Returns: string }
      get_document_key_for_workspace: {
        Args: { p_workspace_id: string }
        Returns: string
      }
      ...
      increment_agent_stat: {
        Args: { _agent: string; _field: string; _medium: string }
        Returns: undefined
      }
    ...
    Enums: {
      ...
      project_knowledge_status: "draft" | "published" | "retired"
      resource_category:
        | "crisis"
        | "legal"
        | "local"
